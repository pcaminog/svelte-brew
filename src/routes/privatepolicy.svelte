...
<div>
	<div class="flex flex-col h-screen border-collapse overflow-hidden">
		...
		<div class="grid  place-items-center font-mono overflow-y-scroll">
			<div class="grid place-items-center w-3/4 gap-10 m-5 text-base">
				...
				<ul>
					...
					<li>
						<p>
							...
							&quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Brew It.
						</p>
					</li>
					<li>
						<p>
					...
					<li>
						<p>
							<strong>Website</strong> refers to Brew It, accessible from
							<a href="https://www.brewit.dev" rel="external nofollow noopener" target="_blank"
								>https://www.brewit.dev</a
							>
						</p>
					</li>
					<li>
				...
				<p>
					...
					Cookies are deleted as soon as You close Your web browser. Learn more about cookies on the <a
				...
				<ul>
					...
					<li>
						<p>
							...
							or similar proceeding, in which Personal Data held by Us about our Service users is among
				...
				<ul>
					...
					<li>
						...
						in the public areas with other users, such information may be viewed by all users and may
				...
				<ul>
					<li>By email: privacypol@brewit.dev</li>
				</ul>
			</div>
		</div>
	</div>
